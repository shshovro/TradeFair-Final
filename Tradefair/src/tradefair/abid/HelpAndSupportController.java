 ...
 * @author kazia
 */
public class HelpAndSupportController implements Initializable {

    @FXML
    private ComboBox<?> commonissues;
    @FXML
    ...
    @FXML
    private void phone(ActionEvent event) {
    }
    ...
    @FXML
    private void solved(ActionEvent event) throws IOException {

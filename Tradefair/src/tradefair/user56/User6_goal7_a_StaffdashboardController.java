 ...
 * @author WALTON
 */
public class User6_goal7_a_StaffdashboardController implements Initializable {
    ...
    private void AddNewProductBtn(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("user6_goal7_a_Staffadding.fxml"));
        Parent root = loader.load();
         User6_goal7_a_StaffaddingController controller = loader.getController();
         // Replace with actual values
        BorderPane.setCenter(root); 
        } 

 ...
 * @author WALTON
 */
public class User6_goal8_a_surveyviewController implements Initializable {
    ...
    private void showInformationButtonOnClick(ActionEvent event)  {
        ...
        try {
            ...
            Logger.getLogger(User6_goal8_a_surveyviewController.class.getName()).log(Level.SEVERE, null, ex);
        } 
    }

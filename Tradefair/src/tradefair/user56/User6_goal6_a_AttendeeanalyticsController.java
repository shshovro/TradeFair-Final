...
import trade.fair.SecMgr.AttendeeListController;
 ...
 * @author WALTON
 */
public class User6_goal6_a_AttendeeanalyticsController implements Initializable {
    ...
    private void ViewProductsBtn(ActionEvent event)throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/trade/fair/SecMgr/AttendeeList.fxml"));
